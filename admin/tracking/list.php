    ...
    <!--<div id="main">
        ...
        <div class="whole">
            ...
            <div class="list-group">
                ...
                <a href="track.php?user_id=<?php echo $id ;?>&city=<?php echo $apply_city ?>&applicant=<?php echo $applicant; ?>" class="list-group-item list-group-item-action flex-column align-items-start zoom">
                    <div class="d-flex w-100 justify-content-between">
